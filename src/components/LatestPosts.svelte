...
<div class="max-w-5xl px-6 mx-auto text-center">
	...
	<div class="flex flex-col items-center justify-center mt-6">
		...
		>
			<div class="flex items-center justify-between px-4 py-2">
				<h3 class="text-lg font-medium text-gray-700">
					Pydash - Full-blown clone of Geometry Dash implemented in
					Python (Pygame).
				</h3>
				<span class="block text-sm font-light text-gray-600"
					>Nov-2020 - Dec-2020</span
				>
			</div>
		</a>
		...
		>
			<div class="flex items-center justify-between px-4 py-2">
				<h3 class="text-lg font-medium text-gray-700">
					FragmentQR: A chrome extension that copies links that
					highlight relevant text when opened
				</h3>
				<span class="block text-sm font-light text-gray-600"
	...
	<div class="flex items-center justify-center mt-12">
		<a
			class="hover:underline hover:text-gray-500 flex items-center text-gray-600"
			href="#"
		>
			<span>View More</span>
